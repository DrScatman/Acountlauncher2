...
import bot_management.data.LaunchedClient;
import bot_management.data.Launcher;
import bot_management.data.QuickLaunch;
...
public class BotManagement {
    ...
    private static final String DEFAULT_JVM_ARGS = "-Xmx1000m -Djava.net.preferIPv4Stack=true -Djava.net.preferIPv4Addresses=true -Xss2m";
